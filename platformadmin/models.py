...
class Business(models.Model):
    ...
    token_balance = models.PositiveIntegerField(default=0)      # 1 token = 1 cycle of 1 module
...
class TokenTransaction(models.Model):
    """Positive = top-up credited by the software owner; negative = renewal consumption."""
    business = models.ForeignKey(Business, on_delete=models.CASCADE, related_name="token_transactions")
