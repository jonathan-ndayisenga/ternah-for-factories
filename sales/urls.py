...
urlpatterns = [
    ...
    path("pos/return-stock/", views.stock_return_create, name="stock_return_create"),
    path("stock-returns/<int:pk>/confirm/", views.stock_return_confirm, name="stock_return_confirm"),
